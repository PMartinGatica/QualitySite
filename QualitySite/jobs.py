...
def start_scheduler():
    ...
    try:
        ...
        logger.info("Job 'example_job' registrado para ejecutarse cada 30 segundos.")
...
def example_job():
    """
    Job de ejemplo que se ejecuta cada 30 segundos.
    """
    logger.info("El job de ejemplo se está ejecutando correctamente.")